...
- crates.io publishing maintenance
...
- `cargo install gommage-cli`, `cargo install gommage-daemon`, and
  `cargo install gommage-mcp` stay aligned with the signed release line.
